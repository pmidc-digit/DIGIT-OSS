...
//    	System.out.println(criteria);
		...
		if( searchCriteria !=null && businessServicesParms!="" &&  !searchCriteria.getBusinessServices().isEmpty()  &&  workflowUtilV2.isV2Service(searchCriteria.getBusinessServices().get(0)) ){
			businessServicesParms = searchCriteria.getBusinessServices().get(0);
